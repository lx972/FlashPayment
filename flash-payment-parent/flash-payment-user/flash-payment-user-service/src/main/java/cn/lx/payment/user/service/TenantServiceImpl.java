...
import cn.lx.payment.user.api.dto.tenant.*;
import cn.lx.payment.user.convert.*;
import cn.lx.payment.user.entity.*;
import cn.lx.payment.user.mapper.*;
import cn.lx.payment.util.MD5Util;
import cn.lx.payment.util.PhoneUtil;
import cn.lx.payment.util.RandomStringUtil;
...
import cn.lx.payment.user.api.AuthorizationService;
...
import cn.lx.payment.user.api.dto.authorization.RoleDTO;
